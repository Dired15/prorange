...
export default function ShopSection(props)
{
    ...
    return(
        <div className=" xl:px-[5%] lg:px-[3%] md:px-[3%] py-[7%] bg-[hsl(48,15%,94%)] ">
            <div className="flex flex-col items-center py-[2%] mb-24">
                <h3 className="font-medium mb-4">WE RECOMMEND</h3>
                <h2 className="text-5xl font-bold mb-12">Welcome to our shop</h2>
                <ul className="w-full flex flex-row justify-between mb-12 md:flex-wrap">
                    <li className="flex flex-col lg:mb-0 md:mb-16">
            ...
            <div className="aspect-16/6 w-full bg-[url(/shopBg5.jpg)] bg-cover bg-center mb-32"></div>
            <div>
                <ul className="flex flex-row justify-between w-full">
                    <li className="">
                        <div className="aspect-square  lg:w-[6vw] md:w-[8vw] bg-[url(/shopIcon.png)] bg-cover mb-4"></div>
                        <h4 className="text-2xl font-medium mb-4">Quick Selection</h4>
                        <p className="text-lg xl:w-full lg:w-[80%] ">Natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </li>
                    <li>
                        <div className="aspect-square  lg:w-[6vw] md:w-[8vw] bg-[url(/shopIcon2.png)] bg-cover mb-4"></div>
                        <h4 className="text-2xl font-medium mb-4">Convenient packing</h4>
                        <p className="text-lg xl:w-full lg:w-[80%] ">Natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </li>
                    <li>
                        <div className="aspect-square  lg:w-[6vw] md:w-[8vw] bg-[url(/shopIcon3.png)] bg-cover mb-4"></div>
                        <h4 className="text-2xl font-medium mb-4">Calculate delivery free</h4>
                        <p className="text-lg xl:w-full lg:w-[80%] ">Natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </li>
                </ul>
            </div>
